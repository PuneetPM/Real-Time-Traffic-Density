...
Original file is located at
    https://colab.research.google.com/drive/1PLzLLMcdbHzQV_FdPATsNst2oilUqDXl
"""
...
# Source folder containing your model data
source_folder = '/content/runs'

# Destination folder in your Google Drive
destination_folder = '/content/drive/MyDrive/model_traffic2'
...
post_training_files_path = '/content/drive/MyDrive/model_traffic1/detect/train'
...
results_csv_path = os.path.join(post_training_files_path, '/content/drive/MyDrive/model_traffic1/detect/train/results.csv')
...
confusion_matrix_path = os.path.join(post_training_files_path, '/content/drive/MyDrive/model_traffic1/detect/train/confusion_matrix_normalized.png')
...
best_model_path = os.path.join(post_training_files_path, '/content/drive/MyDrive/model_traffic1/detect/train/weights/best.pt')
...
valid_images_path = os.path.join(dataset_path, '/content/drive/MyDrive/Vehicle_Detection_Image_Dataset/valid', '/content/drive/MyDrive/Vehicle_Detection_Image_Dataset/train/images')
...
video_path = '/content/drive/MyDrive/videos/brtsnight4.mp4'
...
!ffmpeg -y -loglevel panic -i /content/runs/detect/predict/brtsnight4.avi processed_sample_video.mp4
...
# Open the video
cap = cv2.VideoCapture('/content/drive/MyDrive/videos/brtsnight4.mp4')
...
while cap.isOpened():
    ...
    if ret:
        ...
        # Determine traffic intensity for the left lane
        if vehicles_in_left_lane <= smooth_threshold:
            traffic_intensity_left = "Smooth"
        elif vehicles_in_left_lane <= medium_threshold:
            traffic_intensity_left = "Medium"
        else:
            traffic_intensity_left = "Heavy"

        # Determine traffic intensity for the right lane
        if vehicles_in_right_lane <= smooth_threshold:
            traffic_intensity_right = "Smooth"
        elif vehicles_in_right_lane <= medium_threshold:
            traffic_intensity_right = "Medium"
        else:
